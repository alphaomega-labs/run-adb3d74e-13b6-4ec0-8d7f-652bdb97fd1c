...
\node[align=center,font=\sffamily] at (5.5,3.22) {Cell value = unsafe commits across four seeded boundary probes};
...
\node[anchor=west,font=\sffamily\footnotesize] at (4.9,-1.52) {\tikz\fill[fail] (0,0) rectangle (0.28,0.16); premise-violation regime};
