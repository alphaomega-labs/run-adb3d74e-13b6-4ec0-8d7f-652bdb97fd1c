...
\node[align=center,font=\sffamily] at (5.5,3.22) {Cell value = mean unsafe-commit rate};
...
\newcommand{\cell}[4]{%
  ...
  \node[font=\sffamily\bfseries\large,text=white] at ({#1*\cellw+1.38},{1.64-#2*\cellh}) {#3};
}
\cell{0}{0}{0.0}{safe}
\cell{1}{0}{1.0}{fail}
\cell{2}{0}{1.0}{fail}
...
\node[rotate=90,font=\sffamily\footnotesize] at (-1.55,0.82) {Assumption profile};
