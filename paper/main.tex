...
\renewcommand{\arraystretch}{1.1}
\setlength{\tabcolsep}{4pt}
\resizebox{\linewidth}{!}{\begingroup\catcode`\_=12\relax\input{\maintablepath{safety_assumption_matrix.tex}}\endgroup}
\end{table}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.68\linewidth]{\mainfigurepath{recovery_bounds.pdf}}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.68\linewidth]{\mainfigurepath{far_frr_frontier.pdf}}
...
\renewcommand{\arraystretch}{1.1}
\setlength{\tabcolsep}{4pt}
\resizebox{\linewidth}{!}{\begingroup\catcode`\_=12\relax\input{\maintablepath{security_attack_coverage.tex}}\endgroup}
\end{table}
